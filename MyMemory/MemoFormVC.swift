...
//        self.contents.attributedText = NSAttributedString(string: " ", attributes: [NSAttributedStringKey.paragraphStyle: style]) // ⇨ iOS11
        self.contents.attributedText = NSAttributedString(string: " ", attributes: [NSParagraphStyleAttributeName: style])
        self.contents.text = ""
    }
